...
final class LoaderViewControllerMia: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if !isFirstStartCompleted {
            SoundMusicManager.shared.isAllowedMusic = true
            SoundMusicManager.shared.isAllowedSounds = true
            SoundMusicManager.shared.isAllowedVibration = true
...
//        print(font)
        ...
        if isInitial {
            ...
            UIView.animate(withDuration: 0.4) {
                ...
                if isFinished {
                    if LevelManager.shared.isTutorialShowed {
